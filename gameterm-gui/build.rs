fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in gameterm -h.
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription",  "GameTerm - Wez's Terminal Emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Wez Furlong, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "GameTerm\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/GameTerm.app/Contents/Info.plist");

...
use gameterm_visual::{
    ...
    VisualInput, VisualMode, VisualModeOutcome, VisualRenderSnapshot, VisualResolvedSprite,
    VisualScene, VisualSceneDialoguePatch, VisualScenePatch, VisualSceneSource,
    VisualSpriteManifestStatus, VisualView, VnDialogueScrollMetrics, VnOverlayRect,
};
...
use visual_command_dispatch::{
    dispatch_pending_action, write_story_state_file, RunCommandDispatch, RunCommandResult,
};

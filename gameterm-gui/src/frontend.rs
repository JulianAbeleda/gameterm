...
use std::rc::Rc;
use std::sync::Arc;
use gameterm_term::{Alert, ClipboardSelection};
...
impl GuiFrontEnd {
    pub fn try_new() -> anyhow::Result<Rc<GuiFrontEnd>> {
        ...
        // `gameterm.gui.get_appearance()` can have that take effect
        ...
        match event {
            ApplicationEvent::OpenCommandScript(file_name) => {
                ...
                promise::spawn::spawn(async move {
                    ...
                    // user's rc files before running the script.  Without this, gameterm on macOS

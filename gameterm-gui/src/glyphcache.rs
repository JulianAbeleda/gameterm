...
use gameterm_blob_leases::{BlobLease, BlobManager, BoxedReader};
use gameterm_font::units::*;
use gameterm_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use gameterm_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/JulianAbeleda/gameterm/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that gameterm can use when rendering.
                    ...
                    // <https://github.com/JulianAbeleda/gameterm/issues/3260>

...
use gameterm_font::units::PixelUnit;
use gameterm_font::LoadedFont;
...
impl Element {
    ...
    pub fn with_line(font: &Rc<LoadedFont>, line: &Line, palette: &ColorPalette) -> Self {
        ...
        for cluster in line.cluster(None) {
            ...
            // <https://github.com/JulianAbeleda/gameterm/issues/2560>
    ...
    pub fn compute_element<'a>(
        ...
        match &element.content {
            ElementContent::Text(s) => {
                ...
                let direction = gameterm_bidi::Direction::LeftToRight;

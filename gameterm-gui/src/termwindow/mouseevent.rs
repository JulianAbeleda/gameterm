...
use gameterm_dynamic::ToDynamic;
use gameterm_term::input::{MouseButton, MouseEventKind as TMEK};
use gameterm_term::{ClickPosition, LastMouseClick, StableRowIndex};
...
impl super::TermWindow {
    ...
    fn mouse_event_terminal(
        ...
        let mouse_event = gameterm_term::MouseEvent {

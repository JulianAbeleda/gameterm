...
impl WebGpuTexture {
    pub fn new(width: u32, height: u32, state: &WebGpuState) -> anyhow::Result<Self> {
        ...
        if width > limit || height > limit {
            ...
            // <https://github.com/JulianAbeleda/gameterm/issues/3713>
            anyhow::bail!(
...
impl WebGpuState {
    ...
    pub async fn new_impl(
        ...
        // to panic
        // <https://github.com/JulianAbeleda/gameterm/issues/3565>
    ...
    pub fn resize(&self, mut dims: Dimensions) {
        ...
        *self.dimensions.borrow_mut() = dims;
        ...
        if config.width > 0 && config.height > 0 {
            ...
            // panic in that case
            // <https://github.com/JulianAbeleda/gameterm/issues/2881>

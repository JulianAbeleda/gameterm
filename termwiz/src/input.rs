...
use std::fmt::Write;
use gameterm_input_types::ctrl_mapping;

pub use gameterm_input_types::Modifiers;
...
pub use gameterm_escape_parser::csi::MouseButtons;
            ...
            match self.state {
                InputState::Pasting(offset) => {
                    ...
                    if let Some(idx) = self.buf.find_subsequence(offset, end_paste) {
                        ...
                        // <https://github.com/JulianAbeleda/gameterm/pull/1832>
                        self.state =

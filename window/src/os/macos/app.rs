...
const CLS_NAME: &str = "GameTermAppDelegate";
    ...
    unsafe {
        match config::configuration().window_close_confirmation {
            ...
            WindowCloseConfirmation::AlwaysPrompt => {
                ...
                let message_text = nsstring("Terminate GameTerm?");
                let info_text = nsstring("Detach and close all panes and terminate gameterm?");
...
extern "C" fn application_dock_menu(
    ...
    let new_window_item =
        MenuItem::new_with("New Window", Some(sel!(gametermPerformKeyAssignment:)), "");
    new_window_item
    ...
    Class::get(CLS_NAME).unwrap_or_else(|| {
        ...
        unsafe {
            ...
            cls.add_method(
                ...
                gameterm_perform_key_assignment as extern "C" fn(&mut Object, Sel, *mut Object),
            );
            cls.add_method(

...
use gameterm_color_types::SrgbaTuple;
use gameterm_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use gameterm_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                gameterm_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;

...
use gameterm_input_types::{KeyboardLedStatus, PhysKeyCode};
        ...
        match self.state.status() {
            ComposeStatus::Composing => {
                ...
                if self.composition.is_empty() || previously_composing {
                    ...
                    // <https://github.com/JulianAbeleda/gameterm/issues/4511>
...
impl KeyboardWithFallback {
    ...
    // <https://github.com/JulianAbeleda/gameterm/issues/4615>
        ...
        let ksym = if pressed {
            ...
            match selected_feed {
                ...
                FeedResult::Nothing(utf8, sym) => {
                    ...
                    //
                    // <https://github.com/JulianAbeleda/gameterm/issues/1851>
                    // <https://github.com/JulianAbeleda/gameterm/issues/2845>
                            ...
                            .intersects(Modifiers::CTRL | Modifiers::ALT | Modifiers::SUPER)
                    {
                        ...
                        // <https://github.com/JulianAbeleda/gameterm/issues/4910> for context.
                        match fallback_feed {
                            FeedResult::Nothing(_fb_utf8, fb_sym) => {
                                log::trace!(
                                    "process_key_event: RawKeyEvent using fallback \

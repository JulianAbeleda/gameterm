...
use gameterm_input_types::{KeyCode, KeyEvent, KeyboardLedStatus, Modifiers};
...
impl XWindowInner {
        ...
        match event {
            ...
            Event::X(xcb::x::Event::SelectionRequest(e)) => {
                if let Err(err) = self.selection_request(e) {
                    ...
                    // <https://github.com/JulianAbeleda/gameterm/pull/6135>
    ...
    pub fn dispatch_ime_text(&mut self, text: &str) {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/4841>
        self.events
...
impl XWindow {
        ...
        F: 'static + FnMut(WindowEvent, &Window),
    {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/2155>
...
impl XWindowInner {
    fn close(&mut self) {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/2198>
...
impl WindowOps for XWindow {
    ...
    fn get_clipboard(&self, clipboard: Clipboard) -> Future<String> {
        ...
        XConnection::with_window_inner(window_id, move |inner| {
            ...
            // where the selection owner moves between two gameterm windows
            ...
            // <https://github.com/JulianAbeleda/gameterm/issues/2110>

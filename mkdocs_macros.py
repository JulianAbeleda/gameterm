...
def define_env(env):
    ...
    def since(vers, outline=False, inline=False):
        if vers == "nightly":
            ...
            expanded = "+"
            blurb = f"""
    The functionality described in this section requires a nightly build of gameterm.
...
"""
            ...
            expanded = ""
            blurb = f"""
    *The functionality described in this section requires version {vers} of gameterm,

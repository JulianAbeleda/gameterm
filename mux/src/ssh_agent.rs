...
/// AgentProxy manages an agent.PID symlink in the gameterm runtime
/// directory.
...
///
/// As a further complication, when a gameterm proxy client is
...
impl AgentProxy {
    ...
    fn update_now(&self) {
        ...
        clients.sort_by(|a, b| {
            ...
            // in gameterm-mux-server-impl/src/sessionhandler.rs

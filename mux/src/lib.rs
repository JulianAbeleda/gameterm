...
use thiserror::*;
use gameterm_term::{Clipboard, ClipboardSelection, DownloadHandler, TerminalSize};
#[cfg(windows)]
...
impl gameterm_term::DownloadHandler for MuxDownloader {

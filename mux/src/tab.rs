...
use std::sync::Arc;
use url::Url;
use gameterm_term::{StableRowIndex, TerminalSize};
...
impl TabInner {
        ...
        !self
            .remove_pane_if(
                |_, pane| {
                    ...
                    // <https://github.com/JulianAbeleda/gameterm/issues/4030>
    ...
    fn compute_split_size(
        ...
        // a bogus split state (https://github.com/JulianAbeleda/gameterm/issues/723)
...
mod test {
    ...
    use gameterm_term::{KeyCode, KeyModifiers, Line, MouseEvent, StableRowIndex};

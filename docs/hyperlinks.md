gameterm has support for both implicit and explicit hyperlinks.
...
config.hyperlink_rules = gameterm.default_hyperlink_rules()
...
-- ( "nvim-treesitter/nvim-treesitter" | wbthomason/packer.nvim | gameterm/gameterm | "gameterm/gameterm.git" )
...
[default_hyperlink_rules](config/lua/gameterm/default_hyperlink_rules.md).


### Explicit Hyperlinks

gameterm supports the relatively new [Hyperlinks in Terminal

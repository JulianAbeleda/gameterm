...
GameTerm is available [via the ports system](https://www.freshports.org/x11/gameterm/).

The most common FreeBSD architectures have pre-built binaries which you can install via:

```console
$ pkg install gameterm
```

The version available in ports is not directly managed by the release
automation of the GameTerm project and may lag behind the latest release.  If

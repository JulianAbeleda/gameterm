...
option, `gameterm` supports defining additional named key tables using the
...
Each `gameterm` GUI window maintains a stack of activations, which allows you to
...
yourself by re-saving your gameterm configuration to trigger a reload.

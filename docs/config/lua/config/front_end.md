...
more scope in earlier versions of gameterm, but today it allows three
possible values:
...
GameTerm will automatically select `Software` if it detects that it is
...
The WebGpu front end allows gameterm to use GPU acceleration provided by

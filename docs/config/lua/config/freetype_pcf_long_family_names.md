...
## Why doesn't gameterm use the distro FreeType or match its configuration?

For the sake of consistency, gameterm vendors in its own copy of
...
version of gameterm are the same on all platforms regardless of

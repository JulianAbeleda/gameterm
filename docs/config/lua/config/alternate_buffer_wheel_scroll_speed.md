...
In this mode, if the application hasn't enabled mouse reporting, gameterm will
...
In versions of gameterm prior to this configuration option being available, the

...
You can use the [gameterm.gui.enumerate_gpus()](../gameterm.gui/enumerate_gpus.md) function
...
local config = {}
local gpus = gameterm.gui.enumerate_gpus()
...
for _, gpu in ipairs(gameterm.gui.enumerate_gpus()) do

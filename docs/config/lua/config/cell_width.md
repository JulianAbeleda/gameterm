...
selecting a font using [gameterm.font](../gameterm/font.md) or
[gameterm.font_with_fallback](../gameterm/font_with_fallback.md) as that will
...
gameterm considers to be the cell boundaries. When rendering monospace, gameterm

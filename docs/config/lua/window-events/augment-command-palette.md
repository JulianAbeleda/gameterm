...
* `doc` - optional: a long description that may be shown after the entry, or that
  may be used in future versions of gameterm to provide more information about the
  command.
...
* `icon` - optional Nerd Fonts glyph name to use for the icon for the entry. See
  [gameterm.nerdfonts](../gameterm/nerdfonts.md) for a list of icon names.
...
gameterm.on('augment-command-palette', function(window, pane)
  return {
    {
      brief = 'Rename tab',
      icon = 'md_rename_box',

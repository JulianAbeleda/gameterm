# `gameterm.color.save_scheme(colors, metadata, file_name)`

{{since('20220807-113146-c2fee766')}}

Saves a color scheme as a gameterm TOML file.
...
> gameterm.color.save_scheme(colors, metadata, "/tmp/cupcacke.toml")
```

# `gameterm.color.load_base16_scheme(file_name)`
...
Note that gameterm ships with the base16 color schemes that were referenced via
...
that was created after your version of gameterm was built.
...
```
> colors, metadata = gameterm.color.load_base16_scheme("/tmp/cupcake.yaml")
> print(colors)

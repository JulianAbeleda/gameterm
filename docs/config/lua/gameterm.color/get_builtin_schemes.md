# `gameterm.color.get_builtin_schemes()`

{{since('20220807-113146-c2fee766')}}

(In earlier releases, you can use [gameterm.get_builtin_color_schemes()](../gameterm/get_builtin_color_schemes.md))
...
local schemes = {}
for name, scheme in pairs(gameterm.color.get_builtin_schemes()) do
...
local scheme = gameterm.color.get_builtin_schemes()['Gruvbox Light']
...
local function dark_schemes()
  local schemes = gameterm.color.get_builtin_schemes()
  local dark = {}

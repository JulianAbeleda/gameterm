# `gameterm.color.extract_colors_from_image(filename [,params])`
...
```
> gameterm.color.extract_colors_from_image("/wallpapers/neon-nights.jpeg")
[
    "#060a14",
    "#7393d4",
    "#9f475a",
...
used on a full 4K image file.  To reduce the runtime, gameterm will by
...
```
> gameterm.color.extract_colors_from_image("/wallpaper/neon-nights.jpeg", {
  num_colors=16,
  threshold=75
})
[
...
local colors = gameterm.color.extract_colors_from_image '/path/to/image/jpeg'
local ansi = {}
local brights = {}

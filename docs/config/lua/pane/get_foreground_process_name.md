...
* Querying the path may fail for a variety of reasons outside of the control of GameTerm
* Querying process information has some runtime overhead, which may cause gameterm to slow down if over-used.

...
gameterm.action.SpawnCommandInNewWindow {
  ...
  -- If omitted, gameterm will infer a value based on the active pane
  ...
  -- gameterm using `gameterm connect` or `gameterm serial` then the default
  ...
  -- gameterm.mux.spawn_window, SpawnCommandInNewWindow
  position = {
    x = 10,
    y = 300,

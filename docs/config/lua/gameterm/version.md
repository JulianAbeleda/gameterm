...
This constant is set to the `gameterm` version string that is also reported
by running `gameterm -V`.  This can potentially be used to adjust configuration
...
gameterm.log_error('Version ' .. gameterm.version)
```

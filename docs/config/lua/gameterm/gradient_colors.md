---
title: gameterm.gradient_colors
tags:
 - color
---

# `gameterm.gradient_colors(gradient, num_colors)`
...
```
> gameterm.gradient_colors({preset="Rainbow"}, 4)
...
[gameterm.color.gradient](../gameterm.color/gradient.md) and that name

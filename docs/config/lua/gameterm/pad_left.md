---
title: gameterm.pad_left
tags:
 - utility
 - string
---
# gameterm.pad_left(string, min_width)
...
For example, `gameterm.pad_left("o", 3)` returns `"  o"`.

See also: [gameterm.truncate_left](truncate_left.md), [gameterm.pad_right](pad_right.md).

---
title: gameterm.enumerate_ssh_hosts
tags:
 - ssh
---

# gameterm.enumerate_ssh_hosts(\[ssh_config_file_name, ...\])
...
list as though
[gameterm.add_to_config_reload_watch_list()](add_to_config_reload_watch_list.md)
...
for host, config in pairs(gameterm.enumerate_ssh_hosts()) do
  table.insert(ssh_domains, {
    ...
    -- if you don't have gameterm's mux server installed on the remote

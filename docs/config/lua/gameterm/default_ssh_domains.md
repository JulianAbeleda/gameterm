---
title: gameterm.default_ssh_domains
tags:
 - ssh
 - multiplexing
---

# gameterm.default_ssh_domains()
...
require gameterm to be installed on the remote host, while the

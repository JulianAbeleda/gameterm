# `gameterm.mux.set_default_domain(MuxDomain)`
...
default domain that may have happened as a result of starting gameterm via
`gameterm connect` or `gameterm serial`.

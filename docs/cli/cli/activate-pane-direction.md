# `gameterm cli activate-pane-direction DIRECTION`

{{since('20221119-145034-49b9839f')}}

*Run `gameterm cli activate-pane-direction --help` to see more help*
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-activate-pane-direction--help.txt" %}
```

# `gameterm cli move-pane-to-new-tab`

{{since('20220624-141144-bd1b7c5d')}}

*Run `gameterm cli move-pane-to-new-tab --help` to see more help*
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-move-pane-to-new-tab--help.txt" %}
```

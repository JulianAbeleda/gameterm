# `gameterm cli adjust-pane-size DIRECTION`

{{since('20230712-072601-f4abf8fd')}}

*Run `gameterm cli adjust-pane-size --help` to see more help*
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-adjust-pane-size--help.txt" %}
```

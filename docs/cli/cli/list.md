...
*Run `gameterm cli list --help` to see more help*
...
WINID TABID PANEID WORKSPACE SIZE  TITLE                          CWD
    0     0      0 default   80x24 gameterm cli list  -- wez@foo:~ file://foo/home/wez/
```
...
[
  {
    ...
    "title": "gameterm cli list --format json -- wez@foo:~",
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-list--help.txt" %}
```

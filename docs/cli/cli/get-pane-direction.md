# `gameterm cli get-pane-direction DIRECTION`

{{since('20230408-112425-69ae8472')}}

*Run `gameterm cli get-pane-direction --help` to see more help*
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-get-pane-direction--help.txt" %}
```

# `gameterm cli get-text`

{{since('20230320-124340-559cb7b0')}}

*Run `gameterm cli get-text --help` to see more help*
...
```
$ gameterm cli get-text > /tmp/myscreen.txt
```
...
```
$ gameterm cli get-text --escapes > /tmp/myscreen-with-colors.txt
```
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-get-text--help.txt" %}
```

# `gameterm cli list-clients`

*Run `gameterm cli list-clients --help` to see more help*
...
```
$ gameterm cli list-clients --format json
[
  {
    "username": "wez",
    "hostname": "foo",
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-list-clients--help.txt" %}
```

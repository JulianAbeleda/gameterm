# `gameterm cli send-text`

*Run `gameterm cli send-text --help` to see more help*
...
```
$ gameterm cli send-text "hello there"
```
...
```
$ echo hello there | gameterm cli send-text
```
...
```console
{% include "../../examples/cmd-synopsis-gameterm-cli-send-text--help.txt" %}
```

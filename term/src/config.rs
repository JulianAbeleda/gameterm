...
use gameterm_surface::{Line, SequenceNo};
...
impl Default for NewlineCanon {
    fn default() -> Self {
        ...
        //
        // To come to a compromise, if gameterm is running on Windows then we'll
        ...
        if cfg!(windows) {
            ...
            // <https://github.com/JulianAbeleda/gameterm/issues/1575>
            Self::CarriageReturn
        }
    }
}

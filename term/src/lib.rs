...
use gameterm_surface::SequenceNo;
...
pub use gameterm_cell::*;
pub use gameterm_surface::line::*;
...
pub struct CursorPosition {
    ...
    pub shape: gameterm_surface::CursorShape,
    pub visibility: gameterm_surface::CursorVisibility,

...
use gameterm_escape_parser::csi::{Edit, EraseInDisplay, EraseInLine};
use gameterm_escape_parser::{OneBased, OperatingSystemCommand, CSI};
use gameterm_surface::{CursorShape, CursorVisibility, SequenceNo, SEQ_ZERO};
...
fn test_semantic_1539() {
    use gameterm_escape_parser::osc::FinalTermSemanticPrompt;
...
fn test_scroll_margins() {
    ...
    let margins = CSI::Cursor(gameterm_escape_parser::csi::Cursor::SetTopAndBottomMargins {
        top: OneBased::new(1),

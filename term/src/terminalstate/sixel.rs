...
use ::image::RgbaImage;
use gameterm_cell::color::RgbColor;
use gameterm_cell::image::ImageDataType;
use gameterm_escape_parser::{Sixel, SixelData};
        ...
        for d in &sixel.data {
            match d {
                ...
                SixelData::DefineColorMapHSL {
                    ...
                    // https://github.com/JulianAbeleda/gameterm/issues/775

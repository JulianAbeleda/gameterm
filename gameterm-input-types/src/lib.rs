...
bitflags! {
    ...
    pub struct Modifiers: u16 {
        ...
        const LEFT_ALT = 1<<5;
        const RIGHT_ALT = 1<<6;
        /// This is a virtual modifier used by gameterm
        const LEADER = 1<<7;
        const LEFT_CTRL = 1<<8;
...
impl KeyEvent {
    ...
    pub fn encode_kitty(&self, flags: KittyKeyboardFlags) -> String {
        ...
        // See: https://github.com/JulianAbeleda/gameterm/pull/4605#issuecomment-1823604708
...
impl FromDynamic for IntegratedTitleButtonStyle {
    fn from_dynamic(
        ...
        _options: gameterm_dynamic::FromDynamicOptions,
        ...
        Self: Sized,
    {
        ...
        if let gameterm_dynamic::Value::String(string) = value {
            let style = match string.as_str() {
                "Windows" => Self::Windows,
                "Gnome" => Self::Gnome,
                "MacOsNative" if cfg!(target_os = "macos") => Self::MacOsNative,
                _ => {
                    return Err(gameterm_dynamic::Error::InvalidVariantForType {
            ...
            Err(gameterm_dynamic::Error::InvalidVariantForType {

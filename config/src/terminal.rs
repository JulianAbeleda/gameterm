...
use gameterm_term::config::BidiMode;
...
impl gameterm_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> gameterm_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => gameterm_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => gameterm_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => gameterm_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                gameterm_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                gameterm_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }

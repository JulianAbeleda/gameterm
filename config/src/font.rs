...
use std::fmt::Display;
use gameterm_dynamic::{FromDynamic, FromDynamicOptions, ToDynamic, Value};
        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(gameterm_dynamic::Error::NoConversion {
...
impl std::fmt::Display for FontAttributes {
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        write!(
            fmt,
            "gameterm.font('{}', {{weight={}, stretch='{}', style={}}})",
...
impl TextStyle {
    ...
    ///
    /// <https://github.com/JulianAbeleda/gameterm/issues/456>
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<gameterm_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<gameterm_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<gameterm_term::Blink>,

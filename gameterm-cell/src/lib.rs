...
pub use gameterm_char_props::emoji::Presentation;
use gameterm_char_props::emoji_variation::WCWIDTH_TABLE;
use gameterm_char_props::widechar_width::WcWidth;
use gameterm_dynamic::{FromDynamic, ToDynamic};
pub use gameterm_escape_parser::osc::Hyperlink;
...
pub use gameterm_escape_parser::csi::{Blink, Intensity, Underline, VerticalAlign};
...
impl CellAttributes {
    ...
    pub fn clone_sgr_only(&self) -> Self {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/2489>
...
impl UnicodeVersion {
    ...
    fn width(&self, c: WcWidth) -> usize {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/1864>
...
pub fn is_white_space_char(c: char) -> bool {
    gameterm_char_props::white_space::WHITE_SPACE.contains_u32(c as u32)
}
...
///
/// The approach that gameterm wants to take here is to define a
...
mod test {
    ...
    // See <https://github.com/JulianAbeleda/gameterm/issues/6637>
    ...
    // That decision is made over in gameterm-term when processing
    ...
    fn issue_6637() {
        ...
        // due to <https://github.com/JulianAbeleda/gameterm/issues/1422>.

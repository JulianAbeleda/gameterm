...
can be run in the [`get-deps`](https://github.com/JulianAbeleda/gameterm/blob/master/get-deps)
script.
...
Keep in mind that for maximal compatibility and utility `gameterm` aims to
be compatible with the `xterm` behavior.
https://invisible-island.net/xterm/ctlseqs/ctlseqs.html is a useful resource!

The `src` directory holds the code for the `gameterm` program. This is
...
match expectations](https://github.com/JulianAbeleda/gameterm/blob/fd532a8c2fb3b56593597cf8be1775da1feda0a3/term/src/test/mod.rs#L314).

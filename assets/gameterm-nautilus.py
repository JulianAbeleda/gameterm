...
class OpenInGameTermAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in GameTerm',
            icon='org.wezfurlong.gameterm')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='GameTermNautilus::open_in_gameterm', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='GameTermNautilus::open_folder_in_gameterm', paths=paths)]
        else:
            return []

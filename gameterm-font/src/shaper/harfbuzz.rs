...
impl HarfbuzzShaper {
    ...
    fn do_shape(
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/1474> and
        // <https://github.com/JulianAbeleda/gameterm/issues/1573>
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/2572>
        ...
        for (info, pos) in info_iter {
            ...
            if let Some(ref mut cluster) = info_clusters.last_mut() {
                ...
                if info.codepoint == 0 && !no_more_fallbacks {
                    ...
                    if prior.codepoint == 0 || prior.cluster == info.cluster {
                        if prior.cluster + prior.len == info.cluster {
                            ...
                            // <https://github.com/JulianAbeleda/gameterm/issues/2032>
                            continue;
                        }
                ...
                // <https://github.com/JulianAbeleda/gameterm/issues/2482>
        ...
        for infos in &info_clusters {
            ...
            for info in infos.iter() {
                ...
                // <https://github.com/JulianAbeleda/gameterm/issues/1787>
...
impl FontShaper for HarfbuzzShaper {
    ...
    fn metrics_for_idx(&self, font_idx: usize, size: f64, dpi: u32) -> anyhow::Result<FontMetrics> {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/1803>

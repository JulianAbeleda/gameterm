...
#[cfg(feature = "appdata")]
use std::sync::Mutex;
use gameterm_bidi::{Direction, ParagraphDirectionHint};
use gameterm_cell::{Cell, CellAttributes, SemanticType, UnicodeVersion};
...
impl Line {
    ...
    pub fn split_off(&mut self, idx: usize, seqno: SequenceNo) -> Self {
        ...
        // <https://github.com/JulianAbeleda/gameterm/issues/2355>
    ...
    fn set_cell_impl(&mut self, idx: usize, cell: Cell, clear: bool, seqno: SequenceNo) {
        ...
        // https://github.com/JulianAbeleda/gameterm/issues/768

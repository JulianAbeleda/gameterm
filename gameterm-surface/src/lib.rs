...
use gameterm_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use gameterm_cell::image::ImageCell;
use gameterm_cell::{Cell, CellAttributes};
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use gameterm_cell::color::AnsiColor;
    use gameterm_cell::image::ImageData;
    use gameterm_cell::{AttributeChange, Intensity};

...
pub use asset_edit::{
    ...
    sample_scene_asset_image, scene_asset_operation_error_report, stroke_scene_asset_path,
    transform_scene_asset_image, unsharp_mask_scene_asset_image, validate_scene_asset_feature_map,
    write_scene_asset_json, SceneAssetAlphaPaintOptions, SceneAssetAnimationFrame,
    ...
    SceneAssetOperation, SceneAssetOperationErrorReport, SceneAssetOperationExpectations,
    SceneAssetOperationRunOptions, SceneAssetOperationRunReport, SceneAssetPadAnchor,
    ...
    SceneAssetPointSample, SceneAssetRecipeBook, SceneAssetRegionSample, SceneAssetResampleFilter,

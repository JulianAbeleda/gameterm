...
pub use asset_edit::{
    ...
    SceneAssetContinuityReport, SceneAssetContinuityStatus, SceneAssetCutoutQualityReport,
    SceneAssetDefringeMode, SceneAssetDimensions, SceneAssetEditError, SceneAssetEditOperation,
    ...
    SceneAssetHairCleanupMode, SceneAssetHairCleanupReport, SceneAssetImageReport,
    ...
    SceneAssetPaintReport, SceneAssetPipeline, SceneAssetPipelineRoots,

...
pub use asset_edit::{
    ...
    load_scene_asset_state_manifest, magic_erase_add_scene_asset_image,
    ...
    preview_scene_asset_grid, preview_scene_asset_selection_mask, render_scene_asset_state,
    render_scene_asset_state_sheet, report_scene_asset_points, restore_scene_asset_from_source,
    run_scene_asset_edit_session, run_scene_asset_operation, run_scene_asset_pipeline,
    ...
    SceneAssetCompareReport, SceneAssetCompositeLayer, SceneAssetCompositeOptions,
    SceneAssetCompositeReport, SceneAssetContinuityCheck, SceneAssetContinuityReport,
    SceneAssetContinuityStatus, SceneAssetCropOptions, SceneAssetCutoutQualityReport,
    SceneAssetDefringeMode, SceneAssetDimensions, SceneAssetDrawShapeKind,
    SceneAssetDrawShapeOptions, SceneAssetEditError, SceneAssetEditOperation,
    SceneAssetEditSession, SceneAssetEditSessionRunReport, SceneAssetExportReport,
    SceneAssetExpressionOutput, SceneAssetFeatureMap, SceneAssetFillOptions,
    SceneAssetGridPreviewOptions, SceneAssetGridPreviewReport, SceneAssetHairCleanupMode,
    SceneAssetHairCleanupReport, SceneAssetHslOptions, SceneAssetImageReport,
    SceneAssetLevelsOptions, SceneAssetMaskPolishOptions, SceneAssetMaskPreviewMode,
    SceneAssetMaskPreviewOptions, SceneAssetMaskPreviewReport, SceneAssetNormalizedPoint,
    SceneAssetNormalizedRect, SceneAssetOperation, SceneAssetOperationErrorReport,
    SceneAssetOperationExpectations, SceneAssetOperationRunOptions, SceneAssetOperationRunReport,
    SceneAssetPadAnchor, SceneAssetPadOptions, SceneAssetPaintReport, SceneAssetPipeline,
    SceneAssetPipelineRoots, SceneAssetPipelineRunOptions, SceneAssetPipelineRunReport,
    SceneAssetPipelineStep, SceneAssetPipelineStepReport, SceneAssetPixelRect,
    SceneAssetPointReport, SceneAssetPointSample, SceneAssetRecipeBook, SceneAssetRegionSample,
    ...
    SceneAssetSampleReport, SceneAssetSelectionReport, SceneAssetStateManifest,
    SceneAssetStateManifestOptions, SceneAssetStatePart, SceneAssetStateRenderOptions,
    SceneAssetStateSheetFrame, SceneAssetStateSheetIndex, SceneAssetStateSheetIndexFrame,
...
impl VisualInteractiveDebugMenu {
    ...
    fn next_scene_section(self) -> Self {
    ...
    fn previous_scene_section(self) -> Self {
        let idx = Self::SCENE_SECTIONS
            .iter()
            .position(|section| *section == self)
            .unwrap_or(0);
...
impl SceneRuntime {
    ...
    fn debug_menu_row_count(&self) -> usize {

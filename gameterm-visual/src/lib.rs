...
pub use asset_edit::{
    ...
    SceneAssetCloneStampOptions, SceneAssetContinuityCheck, SceneAssetContinuityReport,
    SceneAssetContinuityStatus, SceneAssetCutoutQualityReport, SceneAssetDefringeMode,
    ...
    SceneAssetNormalizedRect, SceneAssetPaintReport, SceneAssetPipeline, SceneAssetPipelineRoots,
    ...
    SceneAssetPointSample, SceneAssetRecipeBook, SceneAssetRegionSample, SceneAssetRestoreFilter,

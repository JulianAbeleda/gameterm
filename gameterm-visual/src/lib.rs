...
pub use asset_edit::{
    ...
    SceneAssetAnimationRecipe, SceneAssetBackgroundSample, SceneAssetCloneStampOptions,
    ...
    SceneAssetImageReport, SceneAssetMaskPolishOptions, SceneAssetMaskPreviewMode,
    SceneAssetMaskPreviewOptions, SceneAssetMaskPreviewReport, SceneAssetNormalizedPoint,
    SceneAssetNormalizedRect, SceneAssetPadAnchor, SceneAssetPadOptions, SceneAssetPaintReport,
